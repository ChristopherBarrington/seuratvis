...
shinyAppUI <- function(...) {
  ...
  more_gene_highlighting.tab <- menuItem(text='Highlight features & clusters', tabName=NS(namespace=tab, id='tab'), icon=icon('search'))
  ...
  more_gene_highlighting.content <- tabItem(tabName=NS(namespace=tab, id='tab'),
                                       ...
                                       fluidRow(more_gene_highlighting.boxes$cluster_dim_plot,
                                                more_gene_highlighting.boxes$sel_cluster_dim_plot,
